<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="a_dashboard"><i class="fa fa-home fa-fw"></i> Dashboard</a>
            </li>
            ...
            <li>
                <a href="#"><i class="fa fa-user fa-fw"></i> Administrator<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li> <a href="tampil">&raquo; Pengguna</a> </li>
                </ul>
            </li>
            <li>
                <a href="#"><i class="fa fa-tasks fa-fw"></i> Timeline<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li> <a href="tampil_timeline">&raquo; Timeline</a> </li>
                    <li> <a href="tampil_thread">&raquo; Thread</a> </li>
                    <li> <a href="tampil_komen">&raquo; Komentar</a> </li>
                </ul>
            </li>
