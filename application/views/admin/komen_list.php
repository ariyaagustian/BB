            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <center><h4 class="card-title ">Daftar Komentar</a></h4></center>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    ?>
                      ...
                      <td><?php echo '<a href="'.base_url().'User_controller/edit_timeline/'.$user->id_komentar.'"><i class="material-icons">border_color</i></a>'?></td>
                      <td><?php echo '<a href="'.base_url().'User_controller/delete_timeline/'.$user->id_komentar.'" onclick="return confirm(\'Anda yakin akan menghapus komentar '.$user->isi.'?\')"><i class="material-icons">restore_from_trash</i></a>'?></td>
                        </tr>
                      <?php } ?>
                      </tbody>
                    </table>
